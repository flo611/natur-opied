...
const NavbarMobile = () => {
  ...
  return (
    <header className="fixed bottom-10 w-full flex justify-center z-50 ">
      ...
      <button class="button">
      <Link to="/destinations" class="text-gray-200 text-xl">
      ...
      <button className="button  border-r-4 text-gray-200 text-xl">
      <Link to="/shop">
        <BiShoppingBag/>
        </Link>
      </button>
      ...
      <button class="button">
      <a class="flex items-center text-gray-200" href="/panier">
                  <svg
      ...
      <Link
                  to="/dashboard"
                  className="flex items-center text-gray-200 text-xl"
                >
